...
@Entity
@Table(name = "evaluation", catalog = "myiuc", schema = "")
@NamedQueries({
...
public class Evaluation implements Serializable {
    ...
    @Column(name = "note")
    private Double note;
    @JoinColumn(name = "code_etud", referencedColumnName = "code_etud", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Etudiant etudiant;
    @JoinColumn(name = "code_mat", referencedColumnName = "code_mat", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public Evaluation(short codeEtud, String codeMat) {
    ...
    public String toString() {
        return "com.myiuc.entities.Evaluation[ evaluationPK=" + evaluationPK + " ]";
    }
